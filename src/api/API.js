...
export const getDepartments = college => {
  ...
  return axios
    .post(Constants.BASE_URL + "department", {
      college: college
    })
    .then(response => {
      return response.data;
...
export const getTimetable = (college, department, year, division = "A") => {
  ...
  return axios
    .post(Constants.BASE_URL + "timetable_view_class", {
      params: {
...
export const getCompleteFacultyTimetable = (college, request) => {
  console.log("timtable getting");
  return axios
    .post(Constants.BASE_URL + "timetable_view_faculty", {
      params: {
        ...request
      },
      college: college
...
export const getPrincipalTimetable = (
  college,
  department,
  year,
  division = "A"
  ...
  return axios
    .post(Constants.BASE_URL + "full_class", {
      params: {
        department: department,
        year: year,
        division: division
...
export const getFacultyInfo = (college, department, year) => {
  ...
  return axios
    .post(Constants.BASE_URL + "faculty_info", {
      params: {
        department: department,
        year: year
      },
...
export const getAllFacultyInfo = college => {
  ...
  return axios
    .post(Constants.BASE_URL + "all_faculty_info", {
      college: college
    })
    .then(res => {
      // console.log(res);
...
export const addTimetable = (request, division = "A", college) => {
  ...
  return axios
    .post(Constants.BASE_URL + "timetable_enter", {
      params: {
        division: division,
        ...request
      },
...
export const deleteTimetable = (college, srno) => {
  return axios
    .post(Constants.BASE_URL + "timetable_record_delete", {
      params: {
        srno: srno
      },
      college: college
...
export const printTimetableClass = (college, request) => {
  ...
  let paramsString = `?college=${college}&params[division]=${
    request.division
  }&params[year]=${request.year}&params[department]=${request.department}`;
  return axios
    .get(Constants.BASE_URL + "print_time_table_class" + paramsString, {})
    .then(res => {
      return res;
    })
    .catch(err => {
...
export const printTimetableFaculty = (college, request) => {
  ...
  return axios
    .get(Constants.BASE_URL + "print_time_table_faculty" + paramsString, {})
    .then(res => {
      return res;
    })
    .catch(err => {
...
export const printTimetableRoom = (college, request) => {
  ...
  return axios
    .get(Constants.BASE_URL + "print_time_table_room" + paramsString, {})
    .then(res => {
      return res;
    })
    .catch(err => {
